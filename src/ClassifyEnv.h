...
extern spEvalPoint makeEvalPoint(const widget::Widget& widget, const char* name, const js::value& jv, FovScale* fov_scale);
extern spEvalRect makeEvalRect(const widget::Widget& widget, const char* name, const js::value& jv, FovScale* fov_scale, bool relative);
extern spEvalLine makeEvalLine(const widget::Widget& widget, const char* name, const js::value& jv, FovScale* fov_scale);
